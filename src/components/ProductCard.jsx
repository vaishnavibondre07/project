...
export const ProductCard = React.memo(({ productData, onClick }) => {
  const { addToCart, isCart } = useCart(); // ✅ no dispatch here
  ...
  return (
    ...
    >
      ...
      <button
        onClick={(e) => {
          e.stopPropagation();
          addToCart(productData); // ✅ call the helper directly
        }}
...
//     <li
//       onClick={onClick}
//       className="bg-white rounded-2xl h-full shadow-md hover:shadow-xl transition duration-300 overflow-hidden p-4 flex flex-col gap-3 cursor-pointer"
//     >
//       <figure className="w-full h-48 flex items-center justify-center bg-gray-100 rounded-xl overflow-hidden">
//         <img
//           src={productData.thumbnail}
...
//         }}
//         disabled={inCart}
//         className={`mt-auto py-2 rounded-lg transition duration-300 ${
//           inCart
